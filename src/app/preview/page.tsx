    ...
    <>
      <main className="flex flex-col md:flex-1 md:overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-3 px-4 md:px-6 pb-6 pt-4 md:flex-1 md:overflow-hidden">
          ...
          <div className="w-full md:w-[360px] md:shrink-0 flex flex-col gap-3 md:overflow-y-auto">
            ...
            <div className="bg-[#18181b] border border-white/10 rounded-2xl overflow-hidden shrink-0">
              <ComplianceChecklist
                ...
                onProceedAnyway={
                  checksRan && !allPassed ? handleApprove : undefined
                }
              />
            </div>
            ...
            {reviewState === "requesting_rework" && (
              <div className="bg-[#18181b] border border-amber-500/20 rounded-2xl p-4 shrink-0">
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Describe the improvements needed. This will be added to the
                  rework queue below.
                </p>
                <textarea
                  value={reworkComment}
              ...
              <div className="px-4 py-3 flex items-center gap-2 border-b border-[#27272a]">
                ...
                {reworkQueue.length > 0 && (
                  <span className="ml-auto text-[10px] font-bold text-gray-500">
                    {pendingRework.length} pending &bull;{" "}
                    {reworkQueue.length - pendingRework.length} resolved
                  </span>
                )}
              </div>
              {reworkQueue.length === 0 ? (
